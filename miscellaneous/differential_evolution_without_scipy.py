...
_status_message = {'maxfev': 'Maximum number of function evaluations has been exceeded.',
...
def differential_evolution(func, bounds, strategy='rand1bin', 
                           ...
                           callback=None, disp=False, ncore=1,
...
class DifferentialEvolutionSolver(object):
    ...
    def __init__(self, func, bounds, prev_result=OptimizeResult(), 
        ...
        if best_arg is not None:
            maxval = np.argmax(self.population_energies)
            self.population[maxval] = (np.array(best_arg)-self.__scale_arg1)/self.__scale_arg2
            self.population_energies[maxval] = self.func(best_arg)
            #print(self.population_energies[maxval])
